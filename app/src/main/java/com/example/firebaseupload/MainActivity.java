...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mSwipeCardsActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwipeCardsActivity = findViewById(R.id.text_view_swipe_cards);
        ...
        mSwipeCardsActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openSwipeImageActivity();
            }
        });
    }
    ...
    private void openSwipeImageActivity(){
